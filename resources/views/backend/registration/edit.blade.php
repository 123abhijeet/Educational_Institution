		...
		<div class="page-header">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-12">
					<h5 class="text-uppercase mb-0 mt-0 page-title">Edit Registration</h5>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-12">
					<ul class="breadcrumb float-right p-0 mb-0">
						...
						<li class="breadcrumb-item"><span> Edit Registration</span></li>
					</ul>
				</div>
			</div>
		</div>
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<form method="post" action="{{route('registrations.update',$registration->id)}}">
										...
										<div class="form-group">
											...
											<input type="hidden" name="course" value="{{ $registration->course }}">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control @error('student_name') is-invalid @enderror" name="student_name" value="{{$registration->student_name}}" />
											@error('student_name')
										...
										<div class="form-group">
											...
											<input type="text" class="form-control @error('fathers_occupation') is-invalid @enderror" name="fathers_occupation" value="{{$registration->fathers_occupation}}" />
										...
										<div class="form-group">
											...
											<input type="text" class="form-control @error('aadhar_no') is-invalid @enderror" name="aadhar_no" value="{{$registration->aadhar_no}}" />
											@error('aadhar_no')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control @error('fathers_name') is-invalid @enderror" name="fathers_name" value="{{$registration->fathers_name}}" />
										@error('fathers_name')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{$registration->mobile}}" />
										@error('mobile')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group">
										...
										<textarea class="form-control @error('professionl_qualification') is-invalid @enderror" rows="1" name="professionl_qualification">{{$registration->professionl_qualification}}</textarea>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group">
										...
										<textarea class="form-control @error('address') is-invalid @enderror" rows="4" name="address">{{$registration->address}}</textarea>
										@error('address')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										...
										<input type="text" id="course_fee" class="form-control @error('course_fee') is-invalid @enderror" name="course_fee" value="{{$registration->course_fee}}" readonly/>
										@error('course_fee')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="enrollment_no" value="{{$registration->enrollment_no}}" />
									</div>
									<div class="form-group">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										...
										<input type="text" id="paid_amount" class="form-control @error('paid_amount') is-invalid @enderror" name="paid_amount" value="{{$registration->paid_amount}}" readonly/>
										@error('paid_amount')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
									...
									<div class="form-group">
										...
										<input type="text" id="concession" class="form-control @error('concession') is-invalid @enderror" name="concession" value="{{$registration->concession}}" readonly/>
										@error('concession')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
