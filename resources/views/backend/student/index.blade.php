    ...
    <div class="content container-fluid">
        ...
        <!-- <div class="row">
            ...
            <div class="col-sm-8 col-12 text-right add-btn-col">
                <a href="{{route('students.create')}}" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Student</a>
            </div>
        </div> -->
        <div class="row">
            <div class="col-sm-12">
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <!-- <a class="dropdown-item" href="{{route('students.edit',$item->id)}}"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> -->
                                                        <a class="dropdown-item" href="{{route('students.show',$item->id)}}"><i class="fas fa-eye m-r-5"></i> View</a>
