						...
						<div class="card-body">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										<label>Name</label>
										<input type="text" class="form-control" name="student_name" value="{{$student->student_name}}" readonly />
									</div>
									<div class="form-group">
										<label>Fathers Name</label>
										<input type="text" class="form-control" name="fathers_name" value="{{$student->fathers_name}}" readonly />
									</div>
									<div class="form-group">
										<label>Email</label>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										...
										<input type="date" class="form-control" name="date_of_admission" value="{{$student->date_of_admission}}" readonly />
									</div>
									<div class="form-group">
										<label>Enrollment No</label>
										<input type="text" class="form-control" name="enrollment_no" value="{{$student->enrollment_no}}" readonly />
									</div>
									<div class="form-group">
										<label>Fathers Occupation</label>
										<input type="text" class="form-control" name="fathers_occupation" value="{{$student->fathers_occupation}}" readonly />
									</div>
									<div class="form-group">
										<label>Mobile number</label>
										<input type="text" class="form-control" name="mobile" value="{{$student->mobile}}" readonly />
									</div>
									<div class="form-group">
										<label>Aadhar</label>
										<a href="{{asset('Student Document/'.$student->aadhar)}}" class="form-control" download="">Download</a>
									</div>
									<div class="form-group">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group">
										...
										<textarea class="form-control" rows="1" name="professionl_qualification" readonly>{{$student->professionl_qualification}}</textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group">
										<label>Address</label>
										<textarea class="form-control" rows="4" name="address" readonly>{{$student->address}}</textarea>
									</div>
								</div>
