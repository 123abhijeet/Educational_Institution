                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    <form method="post" action="{{route('courses.store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Course Unique ID <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('course_video_url') is-invalid @enderror" name="course_video_url" value="{{old('course_video_url')}}" />
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="course_banner" accept="image/*" class="form-control @error('course_banner') is-invalid @enderror" value="{{old('course_banner')}}" />
                                        @error('course_banner')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
