		...
		<div class="page-header">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-12">
					<h5 class="text-uppercase mb-0 mt-0 page-title">View Admission</h5>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-12">
					<ul class="breadcrumb float-right p-0 mb-0">
						...
						<li class="breadcrumb-item"><span> View Admission</span></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										<label>Name</label>
										<input type="text" class="form-control" name="student_name" value="{{$admission->student_name}}" readonly />
									</div>
									<div class="form-group">
										<label>Fathers Occupation</label>
										<input type="text" class="form-control" name="fathers_occupation" value="{{$admission->fathers_occupation}}" readonly />
									</div>
									<div class="form-group">
										<label>DOB</label>
										<input type="date" class="form-control" name="dob" value="{{$admission->dob}}" readonly />
									</div>
									<div class="form-group">
										<label>Aadhar No</label>
										<input type="text" class="form-control" name="mobile" value="{{$admission->aadhar_no}}" readonly />
									</div>
									<div class="form-group">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="fathers_name" value="{{$admission->fathers_name}}" readonly />
									</div>
									<div class="form-group">
										<label>Email</label>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="mobile" value="{{$admission->mobile}}" readonly />
									</div>
									<div class="form-group">
										<label>Picture</label>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group">
										...
										<textarea class="form-control" rows="1" name="professionl_qualification" readonly>{{$admission->professionl_qualification}}</textarea>
									</div>
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group">
										<label>Address</label>
										<textarea class="form-control" rows="4" name="address" readonly>{{$admission->address}}</textarea>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										...
										<input type="text" id="course_fee" class="form-control" name="course_fee" value="{{$admission->course_fee}}" readonly />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="enrollment_no" value="{{$admission->enrollment_no}}" readonly />
									</div>
									<div class="form-group">
										<label>Course Duration <span class="text-danger">(in Days)</span></label>
										<input type="text" class="form-control" name="course_duration" id="course_duration" value="{{$admission->course_duration}}" readonly />
									</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										...
										<input type="text" id="paid_amount" class="form-control" name="paid_amount" value="{{$admission->paid_amount}}" readonly />
									</div>
									<div class="form-group">
										<label>Concession (if any) ₹ <span class="text-danger">*</span></label>
										<input type="text" id="concession" class="form-control" name="concession" value="{{$admission->concession}}" readonly />
									</div>
									<div class="form-group">
