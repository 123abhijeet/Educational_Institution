...
@section('title','Edit Profile | Soft Campus')
@section('body')
@php
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									<form method="post" action="{{route('Update-Profile')}}">
										...
										<div class="form-group">
											...
											<input type="number" name="mobile" class="form-control" value="{{Auth::user()->mobile}}">
										</div>
										@php
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<div class="form-group">
										...
										<input class="form-control datetimepicker-input datetimepicker" type="text" data-toggle="datetimepicker" value="{{Auth::user()->created_at}}" readonly>
									</div>
									<div class="form-group">
