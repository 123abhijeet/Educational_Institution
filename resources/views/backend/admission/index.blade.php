    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-sm-4 add-btn-col" style="margin-left: -90px;">
                <a href="{{route('Generate-Monthly-Report')}}" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Generate Monthly Report</a>
            </div>
            <div class="col-sm-4 text-right add-btn-col" style="margin-left: 60px;">
                <a href="{{route('Generate-Examination-Report')}}" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Generate Examination Report</a>
            </div>
                                ...
                                <table class="table custom-table DataTable" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->email}}</td>
                                            <td>{{$item->mobile}}</td>
                                            <td><a target="_blank" href="{{ asset('Payment Receipt/'.$item->receipt_no.'.pdf') }}">Download</a></td>
                                            <td class="text-right">
                                                <div class="dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="{{route('Generate-Admit-Card',$item->enrollment_no)}}"><i class="fas fa-certificate m-r-5"></i> Generate Admit Card</a>
                                                        <a class="dropdown-item" href="{{route('Generate-ID-Card',$item->enrollment_no)}}"><i class="fas fa-certificate m-r-5"></i> Generate ID Card</a>
