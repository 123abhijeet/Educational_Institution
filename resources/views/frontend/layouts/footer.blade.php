                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="widget widget-company">
                            <a href="{{route('Home')}}"><img src="{{asset('frontend/images/icon/logo.png')}}" alt="image"></a>
                            <div class="address">
                    ...
                    <div class="col-md-3">
                        <div class="widget footer-link">
                            ...
                            <ul>
                                <li><a href="{{route('Home')}}"><i class="fa fa-arrow-right"></i>Home</a></li>
                                <li><a href="{{route('About')}}"><i class="fa fa-arrow-right"></i>About Us</a></li>
                                <li><a href="{{route('Teachers')}}"><i class="fa fa-arrow-right"></i>Teachers</a></li>
                                <li><a href="{{route('Gallery')}}"><i class="fa fa-arrow-right"></i>Our Events</a></li>
